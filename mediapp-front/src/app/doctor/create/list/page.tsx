...
"use client"
import React, { useEffect, useState } from 'react'; //gancho de gerenciamento
                    ...
                    {!!doctors && doctors.map((doctor: any) => (
                        <tr key={doctor._id}>
                            ...
                            <td className='border border-slate-300 text-center'>
                                <button onClick={() => deleteDoctor(doctor._id)} className='bg-red-500 p-2 inline-block text-white text-sm'>Delete</button></td>
                            <td className='border border-slate-300 text-center'>
